...
public class GetDirectionsAsyncTask extends AsyncTask<Map<String, String>, Object, ArrayList<LatLng>>
{
    ...
    public GetDirectionsAsyncTask(HomeFragment activity)
    {
        super();
    ...
    protected ArrayList<LatLng> doInBackground(Map<String, String>... params)
    {
        ...
        try
        {
            ...
            //fare estimate
            String estimate=String.valueOf(md.getDistanceValue(doc));
            Log.i("Fare Estimate", estimate+" meters");
    ...
    private void processException()
    {
    	...
    	Log.e("Routing", "Error retrieving data");
    }
}